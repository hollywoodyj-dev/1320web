...
export const REFLECT_CHAT = {
  placeholder: "Continue reflecting…",
  send: "Send",
  thinking: "Wisewave is reflecting…",
  empty: "Your reflection begins when you send your first message.",
  growthEdge: "Current growth edge",
};

export const REFLECT_INVALID = {
