...
export const RESULT_EXTRAS = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: "No. 1320 is a symbolic self-awareness system — a mirror for reflection, not prediction.",
    },
    {
    ...
    },
    {
      ...
      a: "S3 describes how your energy expresses — not whether you are higher or lower than anyone else.",
    },
  ],
};
