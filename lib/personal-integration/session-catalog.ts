...
export const SESSION_CATALOG: Record<PersonalIntegrationSessionVariant, SessionProduct> = {
  blueprint_integration: {
    ...
    positioning: "For one clear question or an initial focused integration.",
    includes: [
      "Pre-Session Intake",
      "Blueprint Integration Consultant review",
      "Foundation reflection (S1 → S3 → S2 → S0)",
      "Up to one relevant advanced layer",
      "Personal Integration Summary",
      "One Reflection Question + light 7-Day Practice",
    ],
  ...
  focused_life_integration: {
    ...
    positioning: "For one main life theme, recurring pattern or current decision.",
    includes: [
      "Complete Pre-Session Intake review",
      "Foundation + up to two advanced layers",
      "Core Recognition, Growth Edge, Conscious Choice",
  ...
  deep_blueprint_integration: {
    ...
    positioning: "For transitions or several interconnected themes requiring more space.",
    includes: [
      "Extended Intake and Blueprint review",
      "Foundation + up to two advanced layers",
      "More time for lived-context exploration",
      "Pattern interaction and Growth Edge exploration",
      "Full Personal Integration Summary",
      "Personalised 7-Day Practice + follow-up direction",
    ],
    mostRecommended: false,
    cta: CTA,
  },
