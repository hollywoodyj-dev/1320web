/** FS-008 — Living Blueprint / Membership UI copy. */

export const LIVING_BLUEPRINT_META = {
  title: "Living Blueprint | 1320 Membership",
  description:
    "Your immutable Soul Blueprint alongside dynamic Expression — continuity without fixed identity labels.",
};

export const LIVING_BLUEPRINT_HERO = {
  eyebrow: "LIVING BLUEPRINT",
  title: "Your Membership Journey",
  body: "One Soul Blueprint — always read-only. Expression, reflections, and journey memory evolve as you do.",
  boundary: "Continuity for reflection — not surveillance or prediction.",
};

export const EXPRESSION_FORM = {
  label: "Expression Framework stage",
  help: "How you sense you are living your blueprint right now — movement matters more than position.",
