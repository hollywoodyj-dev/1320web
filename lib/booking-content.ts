...
export const BOOKING_WHO_FOR = {
  ...
  items: [
    ...
    "You understand this is symbolic reflection — not prediction or diagnosis",
  ],
};
...
export const BOOKING_FAQ = [
  ...
  },
  {
    ...
    a: "No. A Personal Integration Session is symbolic self-awareness support — not licensed therapy, diagnosis, or clinical treatment.",
  },
  {
    q: "Will you tell me my future?",
    a: "No. We explore patterns and mirrors for integration — not fixed predictions or guaranteed outcomes.",
  },
  {
    q: "Will you read my Full Report to me?",
