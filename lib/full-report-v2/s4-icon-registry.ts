...
/**
 * Official S4 primary icon assets — card pack under `public/S4-20/`.
 * Do not substitute generated or generic symbols when URL is available.
 */
export type S4PrimaryIconAsset = {
  primary_icon_url?: string;
  primary_icon_svg?: string;
  primary_icon_alt: string;
};

export function resolveS4PrimaryIconAsset(code: string, title?: string): S4PrimaryIconAsset {
