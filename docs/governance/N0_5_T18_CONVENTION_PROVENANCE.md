...
**Date:** 2026-09-16 (rev. 2026-09-17c — dependency unblocked)  
**Owner:** Nova  
...
**Artifact:** `qa-artifacts/t18-calculator-survey-partial.json` (target 12–15 rows closed)
...
1. Continue live survey (12–15 calculators × full triplet) — **parallel, not blocking N0.2 / T17**
2. Close survey table → T18 body draft
3. Flag any UNKNOWN triplet immediately to Haze
