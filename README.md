...
| `ADMIN_EMAIL` | Optional | Comma-separated admin emails for `/admin` dashboard |
| `NEXT_PUBLIC_ENABLE_ADMIN_ACCOUNTS` | Optional | Accounts table + stats on `/admin` (default on; set `0` to hide) |
