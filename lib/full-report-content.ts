...
export const FULL_REPORT_META = {
  ...
  description:
    "Explore your complete S0–S9 Soul Blueprint — a symbolic mirror for reflection and integration, not prediction or fixed identity.",
};
...
export const WHO_FOR = {
  ...
  lead: "This report is for you if:",
  items: [
    "You want a deeper mirror beyond your free result.",
    "You value reflection, integration, and self-understanding.",
    "You want language for patterns you already sense but cannot yet name.",
  ],
};

export const WHO_NOT_FOR = {
  title: "Who This Is Not For",
  lead: "This report is not for you if:",
  items: [
    "You want a prediction or fixed answer.",
    "You want medical, psychological, legal, or financial advice.",
    "You want the system to decide your life for you.",
  ],
};
...
export const FULL_REPORT_DISCLAIMER =
  "1320 is a reflective intelligence platform for self-awareness and integration. It is not medical, psychological, legal, or financial advice.";
